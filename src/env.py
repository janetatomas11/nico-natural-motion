...
class NicoEnv(Env):
    ...
    def _setup_simulation(self):
        self.io = PyRepIO(scene=self._scene, start=True, blocking=False, headless=self._headless)
        ...
        self._robot = Motion(motorConfig=self._json, vrep=True, vrepConfig=self._config)
    ...
    def step(self, action):
        ...
        if self._robot.getAngle('l_shoulder_y') == 0.0:
            x = 1
